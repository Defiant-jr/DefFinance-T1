...
const ContasReceber = () => {
    ...
    const filteredContas = useMemo(() => {
        let filtered = [...contas];
        if (filters.cliente) {
            filtered = filtered.filter(conta => conta.cliente_fornecedor?.toLowerCase().includes(filters.cliente.toLowerCase()));
        }
    ...
    return (_jsxs("div", { className: "space-y-8", children: [_jsxs(Helmet, { children: [_jsx("title", { children: "Contas a Receber - SysFina" }), _jsx("meta", { name: "description", content: "Gerencie suas contas a receber com filtros e totalizadores" })] }), _jsx(motion.div, { initial: { opacity: 0, y: -20 }, animate: { opacity: 1, y: 0 }, className: "flex flex-col md:flex-row justify-between items-start md:items-center gap-4", children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsx(Button, { variant: "ghost", size: "icon", onClick: () => navigate('/'), className: "text-white hover:bg-white/10", children: _jsx(ArrowLeft, { className: "w-6 h-6" }) }), _jsxs("div", { children: [_jsx("h1", { className: "text-3xl font-bold gradient-text", children: "Contas a Receber" }), _jsx("p", { className: "text-gray-400 mt-2", children: "Gerencie seus recebimentos" })] })] }) }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-6", children: [_jsxs(Card, { className: "glass-card", children: [_jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [_jsx(CardTitle, { className: "text-sm font-medium text-gray-300", children: "Total Filtrado" }), _jsx(DollarSign, { className: "w-4 h-4 text-blue-400" })] }), _jsxs(CardContent, { children: [_jsx("div", { className: "text-2xl font-bold text-blue-400", children: formatCurrency(totalGeral) }), emCashApplies && (_jsxs("p", { className: "mt-1 text-xs text-gray-400", children: ["Inclui ", formatCurrency(emCashValue), " de saldo em cash."] }))] })] }), _jsxs(Card, { className: "glass-card", children: [_jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [_jsx(CardTitle, { className: "text-sm font-medium text-gray-300", children: "Em Aberto" }), _jsx(Calendar, { className: "w-4 h-4 text-yellow-400" })] }), _jsxs(CardContent, { children: [_jsx("div", { className: "text-2xl font-bold text-yellow-400", children: formatCurrency(totalAbertoValor) }), _jsx("div", { className: "mt-2 space-y-1 text-xs text-gray-400", children: Object.entries(totalAbertoPorUnidade).map(([unit, val]) => (_jsxs("div", { className: "flex justify-between", children: [_jsxs("span", { children: [unit, ":"] }), _jsx("span", { className: "font-semibold", children: formatCurrency(val) })] }, unit))) })] })] }), _jsxs(Card, { className: "glass-card", children: [_jsxs(CardHeader, { className: "flex flex-row items-center justify-between space-y-0 pb-2", children: [_jsx(CardTitle, { className: "text-sm font-medium text-gray-300", children: "Atrasado" }), _jsx(AlertTriangle, { className: "w-4 h-4 text-red-400" })] }), _jsxs(CardContent, { children: [_jsx("div", { className: "text-2xl font-bold text-red-400", children: formatCurrency(totalAtrasadoValor) }), _jsx("div", { className: "mt-2 space-y-1 text-xs text-gray-400", children: totalAtrasadoDetalhes.map(([unit, val]) => (_jsxs("div", { className: "flex justify-between", children: [_jsxs("span", { children: [unit, ":"] }), _jsx("span", { className: "font-semibold", children: formatCurrency(val) })] }, unit))) })] })] })] }), emCashApplies && (_jsx(motion.div, { initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, children: _jsxs(Card, { className: "glass-card border-green-500/40 bg-green-500/5", children: [_jsxs(CardHeader, { className: "flex flex-col gap-2", children: [_jsxs(CardTitle, { className: "text-sm font-medium text-green-300 flex items-center gap-2", children: [_jsx(CheckCircle, { className: "w-4 h-4" }), "Saldo em Cash aplicado"] }), _jsx("p", { className: "text-2xl font-bold text-white", children: formatCurrency(emCashValue) })] }), _jsx(CardContent, { children: _jsx("p", { className: "text-sm text-gray-300", children: "Este valor foi confirmado no Dashboard e est\u00E1 sendo somado automaticamente em todos os c\u00E1lculos de atrasados." }) })] }) })), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.3 }, children: _jsxs(Card, { className: "glass-card", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { className: "text-white flex items-center gap-2", children: [_jsx(Filter, { className: "w-5 h-5" }), "Filtros"] }) }), _jsx(CardContent, { children: _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-5 gap-4", children: [_jsxs("div", { children: [_jsx("label", { className: "text-sm text-gray-300 mb-2 block", children: "Cliente" }), _jsx(Input, { placeholder: "Buscar cliente...", value: filters.cliente, onChange: (e) => setFilters({ ...filters, cliente: e.target.value }), className: "bg-white/10 border-white/20 text-white" })] }), _jsxs("div", { children: [_jsx("label", { className: "text-sm text-gray-300 mb-2 block", children: "Status" }), _jsxs(Select, { value: filters.status, onValueChange: (value) => setFilters({ ...filters, status: value }), children: [_jsx(SelectTrigger, { className: "bg-white/10 border-white/20 text-white", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "todos", children: "Todos" }), _jsx(SelectItem, { value: "aberto", children: "Em Aberto" }), _jsx(SelectItem, { value: "atrasado", children: "Atrasado" }), _jsx(SelectItem, { value: "pago", children: "Pago" })] })] })] }), _jsxs("div", { children: [_jsx("label", { className: "text-sm text-gray-300 mb-2 block", children: "Unidade" }), _jsxs(Select, { value: filters.unidade, onValueChange: (value) => setFilters({ ...filters, unidade: value }), children: [_jsx(SelectTrigger, { className: "bg-white/10 border-white/20 text-white", children: _jsx(SelectValue, {}) }), _jsxs(SelectContent, { children: [_jsx(SelectItem, { value: "todas", children: "Todas" }), _jsx(SelectItem, { value: "CNA Angra dos Reis", children: "CNA Angra dos Reis" }), _jsx(SelectItem, { value: "CNA Mangaratiba", children: "CNA Mangaratiba" }), _jsx(SelectItem, { value: "Casa", children: "Casa" })] })] })] }), _jsxs("div", { children: [_jsx("label", { className: "text-sm text-gray-300 mb-2 block", children: "Data In\u00EDcio" }), _jsx(Input, { type: "date", value: filters.dataInicio, onChange: (e) => setFilters({ ...filters, dataInicio: e.target.value }), className: "bg-white/10 border-white/20 text-white" })] }), _jsxs("div", { children: [_jsx("label", { className: "text-sm text-gray-300 mb-2 block", children: "Data Fim" }), _jsx(Input, { type: "date", value: filters.dataFim, onChange: (e) => setFilters({ ...filters, dataFim: e.target.value }), className: "bg-white/10 border-white/20 text-white" })] })] }) })] }) }), _jsx(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.4 }, className: "space-y-6", children: loading ? _jsx("div", { className: "flex justify-center items-center h-64", children: _jsx("div", { className: "animate-spin rounded-full h-16 w-16 border-t-2 border-b-2 border-blue-500" }) })
                    : Object.entries(groupedContas).map(([date, contasData], index) => (_jsxs(Card, { className: "glass-card", children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex justify-between items-center", children: [_jsxs(CardTitle, { className: "text-white flex items-center gap-2", children: [_jsx(Calendar, { className: "w-5 h-5" }), formatDate(date)] }), _jsx("div", { className: "text-lg font-bold text-green-400", children: formatCurrency(contasData.reduce((s, c) => s + c.valor, 0)) })] }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-3", children: contasData.map((conta) => {
                                        const status = getStatus(conta);
                                        return (_jsxs(motion.div, { initial: { opacity: 0, x: -20 }, animate: { opacity: 1, x: 0 }, transition: { delay: index * 0.1 }, className: "flex flex-col md:flex-row justify-between items-start md:items-center p-4 rounded-lg bg-white/5 border border-white/10", children: [_jsxs("div", { className: "flex items-center gap-3 mb-2 md:mb-0", children: [_jsx("div", { className: "p-2 rounded-lg bg-green-500/20", children: _jsx(User, { className: "w-4 h-4 text-green-400" }) }), _jsxs("div", { children: [_jsx("h3", { className: "font-medium text-white", children: conta.cliente_fornecedor }), _jsx("p", { className: "text-sm text-gray-400", children: conta.descricao })] })] }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("span", { className: `px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(status)}`, children: getStatusLabel(status) }), _jsx("div", { className: "text-lg font-bold text-green-400", children: formatCurrency(conta.valor) }), _jsx("button", { type: "button", onClick: () => handleEditLancamento(conta), className: "p-2 rounded-lg bg-white/5 text-gray-400 hover:text-white hover:bg-white/10 transition-colors", "aria-label": "Editar lan\u00E7amento", children: _jsx(Settings, { className: "w-4 h-4" }) }), status !== 'pago' && (_jsxs(Button, { size: "sm", variant: "outline", className: "text-green-400 border-green-400 hover:bg-green-400 hover:text-black", onClick: () => handleMarkAsPaid(conta.id), children: [_jsx(CheckCircle, { className: "w-4 h-4 mr-2" }), "Recebido"] }))] })] }, conta.id));
